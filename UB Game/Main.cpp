...
int main() {
    ...
    cout << "----------------------------------------------------------------------------------------------------------------------------------" << endl
        ...
        << " ⠀⠀⠀⠈⠢⣀⣸⢳⠛⡄⠀⠀⠀⠁⠀⣧⡀⢸⡽⠗⠁⠀⠀⠀                            " << endl
        << "⠀⠀⠀⠀⠀⠀⠀⠈⠳⡄⠁⢠⠀⠀⠋⢱⢿⣷⡿⠁⠀⠀⠀⠀⠀                            " << endl
        << "⠀ ⠀⠀⠀⠀⠀⠀⠀⡿⠀⢀⠐⠀⢭⣭⣽⣩⡇⠀Howdy Partner! You found me!⠀⠀⠀⠀⠀" << endl
        << "⠀⠀⠀⠀⠀⠀⠀⢀⣴⡇⠑⢬⣀⠀⠀⠀⠀⣿⠀⠀⠀⠀⠀                            ⠀⠀" << endl
        << "⠀⠀⠀⠀⠀⠀⢀⠎⠹⡕⠠⢀⣈⠻⢿⣿⣿⣷⣄⠀⠀⠀⠀⠀                            ⠀" << endl
        << " ⠀⣀⠤⠒⠒⡇⠀⠀⠈⠢⣔⣭⣙⣛⣿⣽⣇⡏⣣⣀⠀⠀⠀⠀                            " << endl
        << " ⠉⠀⠀⠀⠀⠘⡄⠀⠀⣠⠴⡟⠍⡻⠟⣿⠘⣷⣇⢧⡉⠉⠉⠁                            " << endl
        ...
        << " ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠸⠉⢧⠁⡇⠀⠀⠀⠀⠀                            " << endl
        << " ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠃⠀⠛⠀⠀⠀⠀⠀⠀                            " << endl*/
        << "        ____ ___  __________         ________                                                 ___,                     " << endl
        << "        |    |   \\ \\______   \\      / _____ / _____   _____   ____                          __)___)__                  " << endl
        << "        |    |   /  |    |  _/     /   \\  ___\\__   \\ /     \\_/ __ \\                         , =  \\\\\\                   " << endl
        << "        |    |  /   |    |   \\     \\    \\_\\  \\ / __ \\| Y Y  \\  ___/                 ,        \\D_ / \_                  " << endl
        << "        |______/ /\\ | ______  / /\\   \\______  (____ /__|_|  /\\___  >            __ / ).          \\ /=\\                 " << endl
        << "                 \\/         \\/  \\/          \\/    \\/      \\/     \\/            / 6)   \\       ___/_\\_/\\                " << endl
        << "                                                                              / __ /   \\     /_/-\\o____)               " << endl
        << "                                                                             /  ,_/|    \\   \\/  /___ |_                " << endl
        << "                                                                             \\_)o_  \\   _. - ' M):_/ _:)      ___      " << endl
        << "                   -~-~-By: Uros Beronja                                           '---`' \\ >__/  /o / ----.,/ _  \\    " << endl
        << "                                                                                   (          /  /o /          \\)  \\   " << endl
        << "                                                                               ____/         ('  \\,/           (   /   " << endl
        << "_____________________________________________________________________________/________/______)___>__,_________/\\_(_______________" << endl
        << endl
        ...
        << "----------------------------------------------------------------------------------------------------------------------------------" << endl
        << "Your First Duel Awaits. Face them at noon or chichen out? (yes = play game / robot = Let U.B. take over / any other = exit game)" << endl
        << "----------------------------------------------------------------------------------------------------------------------------------" << endl << endl;
    cin >> response1;
